...
export function analyzeMTF(sym, mkt, higherBars, lowerBars, adxMin = 0) {
  ...
  //   (whichever bar actually confirmed the shift, long or short) >= 1.5x its
  //   own trailing average — a real reversal shows a burst of participation
  //   right as structure breaks, not just "the latest candle is busy".
